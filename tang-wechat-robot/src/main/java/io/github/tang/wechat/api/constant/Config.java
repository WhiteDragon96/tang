...
public class Config {
    ...
    private static final String CONF_ASSETS_DIR_DEFAULT = "files";
    ...
    private static final String CONF_AUTO_ADDFRIEND_DEFAULT = "true";
    
    
    /**
     * 当前机器人ID
     */
    private static final String CONF_WEIXIN_ID         = "wechat.weixin.id";
    private static final String CONF_WEIXIN_ID_DEFAULT = "first_weixin";
    ...
    public String weixinId() {
        return props.getProperty(CONF_WEIXIN_ID, CONF_WEIXIN_ID_DEFAULT);
    }

    public Config weixinId(String weixinId) {
        props.setProperty(CONF_WEIXIN_ID, weixinId);
        return this;
    }
    
    /** 生成二维码的路径 */
    public String qrPath() {
        return props.getProperty("web.qr.path", null);
    }
    
    /** 生成二维码的路径 */
    public Config qrPath(String webQrPath) {
        props.setProperty("web.qr.path", webQrPath);
        return this;
    }
