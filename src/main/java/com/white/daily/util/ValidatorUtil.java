...
import com.white.daily.pojo.BaseErrorEnum;
import com.white.daily.pojo.BaseReturnCode;
import com.white.daily.pojo.ResultDto;
...
public class ValidatorUtil {
     ...
     */
    public static <T> void validateWithError(T obj, Class<?>... groups) throws BaseException {
        List<String> errors = validate(obj, groups);
        if (errors == null || errors.isEmpty()) {
            return;
        }

        throw BaseException.instance(BaseErrorEnum.PARAM_CHECK_ERROR, errors.toString());
    }
